...
Funcionalidade: Visualizar Status do processo Quadro Sumário
	...
	Cenario: Visualizando Quadro Sumário
		...
		Entao o software irá abrir o quadro sumário do docente informado, contendo as notas já processada até o momento e as apresentará na tela
		Mas se o docente não possuir notas inseridas no sistema até o momento da solicitação.
		Entao o sistema irá informar que o docente solicitado <mensagem_radoc>
