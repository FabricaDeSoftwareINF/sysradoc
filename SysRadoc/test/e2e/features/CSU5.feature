...
Quando eu clicar sobre um nome de usuário, apareça a opção “Atualizar Dados”
	...
	Cenário 1: Atualizar cadastro
E preencher os campos de dados a serem atualizados papel: CAD, nome: João, matrícula: 54321, e-mail: joao@instituto.com.br, classe: B e nível: 2
E clicar em Atualizar Dados
		Então o sistema irá informar que o cadastro foi atualizado com sucesso.
		
	Cenário 2: Dado inválido
E preencher os campos de dados a serem atualizados nome: Jo@quina ou classe: G ou nível: 13
Então o sistema irá informar que um dos dados está incorreto
