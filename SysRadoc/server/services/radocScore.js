...
exports.calculateScore = function(radoc){
    ...
    for (var subjectsGrad = 0; subjectsGrad < radoc[config.sections[2].header].length; subjectsGrad++){
        score[config.sections[2].header].push((parseInt(radoc[config.sections[2].header][subjectsGrad].CHA) / 32) * 10);
    }

    for (var subjectsLSS = 0; subjectsLSS < radoc[config.sections[3].header].length; subjectsLSS++){
        score[config.sections[3].header].push((parseInt(radoc[config.sections[3].header][subjectsLSS].CHA) / 30) * 10);
    }
    ...
    for (var prod = 0; prod < radoc[config.sections[10].header].length; prod++){
        ...
        if (description.indexOf("publicado em periódico") !== -1){
            if (description.toLowerCase().indexOf("não sujeito à classificação") !== -1)
                prodScore.push({subsection: "1", subitem: "1", score: 10});
            else
                prodScore.push({subsection: "1", subitem: "1", score: 20});

        }
        else if (description.indexOf("Resumo de artigo em periódicos especializados") !== -1){
            prodScore.push({subsection: "1", subitem: "2", score: 5});
        }
        else if (description.indexOf("Artigos ou textos literários em repositórios de publicação eletrônica") !== -1){
            prodScore.push({subsection: "1", subitem: "3", score: 5});
        }
        else if (description.indexOf("Resumo expandido publicado em anais") !== -1){
            if (description.toLowerCase().indexOf("internacional") !== -1)
                prodScore.push({subsection: "1", subitem: "4", score: 8});
            else if (description.toLowerCase().indexOf("nacional") !== -1)
                prodScore.push({subsection: "1", subitem: "4", score: 6});
            else
                prodScore.push({subsection: "1", subitem: "4", score: 4});

        }
        else if (description.indexOf("Resumo simples publicado em anais") !== -1){
            if (description.toLowerCase().indexOf("internacional") !== -1)
                prodScore.push({subsection: "1", subitem: "5", score: 8});
            else if (description.toLowerCase().indexOf("nacional") !== -1)
                prodScore.push({subsection: "1", subitem: "5", score: 6});
            else
                prodScore.push({subsection: "1", subitem: "5", score: 4});
        }
        else if (description.indexOf("Trabalho completo publicado em anais de congresso cientifico") !== -1){
            prodScore.push({subsection: "1", subitem: "6", score: 10});
        }
            ...
            if (description.toLowerCase().indexOf("Participação individual, camerista, solista ou ator principal") !== -1){
                prodScore.push({subsection: "2", subitem: "8", score: 16});
            }
            else {
                prodScore.push({subsection: "2", subitem: "8", score: 5});
            }
        }
        else if (description.indexOf("Exposições e apresentações artísticas nacionais") !== -1){
            if (description.toLowerCase().indexOf("Participação individual, camerista, solista ou ator principal") !== -1){
                prodScore.push({subsection: "2", subitem: "9", score: 20});
            }
            else {
                prodScore.push({subsection: "2", subitem: "9", score: 10});
            }
        }
        else if (description.indexOf("Exposições e apresentações artísticas internacionais") !== -1){
            if (description.toLowerCase().indexOf("Participação individual, camerista, solista ou ator principal") !== -1){
                prodScore.push({subsection: "2", subitem: "10", score: 20});
            }
            else {
                prodScore.push({subsection: "2", subitem: "10", score: 15});
            }
        }
        else if (description.indexOf("Composições musicais") !== -1){
            if (description.toLowerCase().indexOf("Editadas") !== -1)
                prodScore.push({subsection: "2", subitem: "11", score: 20});
                ...
                prodScore.push({subsection: "2", subitem: "11", score: 15});
            ...
            if (description.toLowerCase().indexOf("internacional") !== -1)
                prodScore.push({subsection: "2", subitem: "12", score: 15});
            else if (description.toLowerCase().indexOf("nacional") !== -1)
                prodScore.push({subsection: "2", subitem: "12", score: 10});
            else
                prodScore.push({subsection: "2", subitem: "12", score: 5});
        }
        else if (description.indexOf("Arranjos musicais") !== -1){
            prodScore.push({subsection: "2", subitem: "13", score: 5});
        }
        else if (description.indexOf("Apresentação artística ou cultural em rádio ou TV") !== -1){
            prodScore.push({subsection: "2", subitem: "14", score: 5});
        }
        else if (description.indexOf("Sonoplastia") !== -1){
            prodScore.push({subsection: "2", subitem: "15", score: 3});
        }
            ...
            prodScore.push({subsection: "2", subitem: "10", score: 3});
        }
        else if (description.indexOf("Parecer de consultoria ad hoc para periódicos especializados") !== -1){
            prodScore.push({subsection: "2", subitem: "11", score: 3});
        }
        else if (description.indexOf("realizado em consultoria ou assessoria oficializada por convite, convênio, contrato ou designação") !== -1){
            if (description.indexOf("Parecer") !== -1){
                if (description.indexOf("sem anotação") !== -1)
                    prodScore.push({subsection: "3", subitem: "12", score: 5});
                else
                    prodScore.push({subsection: "3", subitem: "12", score: 10});
    ...
    for (var research = 0; research < radoc[config.sections[5].header].length; research++){
        ...
        if (resTable.indexOf("Coordenador de projeto conjuntos de pesquisa e cooperação científica") !== -1){
            ...
            if (resTable.toLowerCase().indexOf("presidente") !== -1)
                researchScore.push({subsection: "2", subitem: "9", score: 4});
            else if (resTable.toLowerCase().indexOf("comissão organizadora") !== -1)
                researchScore.push({subsection: "2", subitem: "9", score: 2});
        }
        else if (resTable.indexOf("Promoção ou produção de eventos artísticos e científicos regionais") !== -1){
            if (resTable.toLowerCase().indexOf("presidente") !== -1)
                researchScore.push({subsection: "2", subitem: "10", score: 6});
            else if (resTable.toLowerCase().indexOf("comissão organizadora") !== -1)
                researchScore.push({subsection: "2", subitem: "10", score: 3});
        }
        else if (resTable.indexOf("Promoção ou produção de eventos artísticos e científicos nacionais") !== -1){
            if (resTable.toLowerCase().indexOf("presidente") !== -1)
                researchScore.push({subsection: "2", subitem: "11", score: 8});
            else if (resTable.toLowerCase().indexOf("comissão organizadora") !== -1)
                researchScore.push({subsection: "2", subitem: "11", score: 4});
        }
        else if (resTable.indexOf("Promoção ou produção de eventos artísticos e científicos internacionais") !== -1){
            if (resTable.toLowerCase().indexOf("presidente") !== -1)
                researchScore.push({subsection: "2", subitem: "12", score: 10});
            else if (resTable.toLowerCase().indexOf("comissão organizadora") !== -1)
                researchScore.push({subsection: "2", subitem: "12", score: 5});
        }
        else{
            researchScore.push({subsection: "", subitem: "", score: 0});
        }
    }
    ...
    for (var ext = 0; ext < radoc[config.sections[6].header].length; ext++){
        ...
        if (extTable.indexOf("Coordenador de projeto de extensão aprovado com comprovação") !== -1){
            ...
            if (extTable.toLowerCase().indexOf("presidente") !== -1)
                extScore.push({subsection: "2", subitem: "9", score: 4});
            else if (extTable.toLowerCase().indexOf("comissão organizadora") !== -1)
                extScore.push({subsection: "2", subitem: "9", score: 2});
        }
        else if (extTable.indexOf("Promoção ou produção de eventos artísticos e científicos regionais") !== -1){
            if (extTable.toLowerCase().indexOf("presidente") !== -1)
                extScore.push({subsection: "2", subitem: "10", score: 6});
            else if (extTable.toLowerCase().indexOf("comissão organizadora") !== -1)
                extScore.push({subsection: "2", subitem: "10", score: 3});
        }
        else if (extTable.indexOf("Promoção ou produção de eventos artísticos e científicos nacionais") !== -1){
            if (extTable.toLowerCase().indexOf("presidente") !== -1)
                extScore.push({subsection: "2", subitem: "11", score: 8});
            else if (extTable.toLowerCase().indexOf("comissão organizadora") !== -1)
                extScore.push({subsection: "2", subitem: "11", score: 4});
        }
        else if (extTable.indexOf("Promoção ou produção de eventos artísticos e científicos internacionais") !== -1){
            if (extTable.toLowerCase().indexOf("presidente") !== -1)
                extScore.push({subsection: "2", subitem: "12", score: 10});
            else if (extTable.toLowerCase().indexOf("comissão organizadora") !== -1)
                extScore.push({subsection: "2", subitem: "12", score: 5});
        }
        else{
            extScore.push({subsection: "", subitem: "", score: 0});
        }
    }
    ...
    for (var adm = 0; adm < radoc[config.sections[9].header].length; adm++){
        ...
        if (admTable.indexOf("Reitor ou Vice-Reitor ou Pró-Reitor") !== -1){
            admScore.push({subsection: "1", subitem: "1", score: getMonths(radoc[config.sections[9].header][adm]) * 14});
        }
        else if (admTable.indexOf("Chefe de Gabinete") !== -1){
                admScore.push({subsection: "1", subitem: "2", score: getMonths(radoc[config.sections[9].header][adm]) * 10});
        }
        else if (admTable.indexOf("Coordenador ou assessor vinculado à Reitoria") !== -1){
            admScore.push({subsection: "1", subitem: "3", score: getMonths(radoc[config.sections[9].header][adm]) * 10});
        }
        else if (admTable.indexOf("Diretor de Unidade Acadêmica, de Unidade Acadêmica Especial") !== -1){
            admScore.push({subsection: "1", subitem: "4", score: getMonths(radoc[config.sections[9].header][adm]) * 10});
        }
        else if (admTable.indexOf("Diretor de Campus do interior") !== -1){
            admScore.push({subsection: "1", subitem: "5", score: getMonths(radoc[config.sections[9].header][adm]) * 12});
        }
        else if (admTable.indexOf("Vice-diretor de Campus do interior") !== -1){
            admScore.push({subsection: "1", subitem: "6", score: getMonths(radoc[config.sections[9].header][adm]) * 12});
        }
        else if (admTable.indexOf("Diretor Geral do Hospital das Clínicas") !== -1){
            admScore.push({subsection: "1", subitem: "7", score: getMonths(radoc[config.sections[9].header][adm]) * 10});
        }
        else if (admTable.indexOf("Coordenador ou assessor vinculado às Pró-Reitorias ou à Direção dos Campus") !== -1){
            admScore.push({subsection: "1", subitem: "8", score: getMonths(radoc[config.sections[9].header][adm]) * 8});
        }
        else if (admTable.indexOf("Coordenador de Programa de Pós-Graduação stricto sensu") !== -1){
            admScore.push({subsection: "1", subitem: "9", score: getMonths(radoc[config.sections[9].header][adm]) * 8});
        }
        else if (admTable.indexOf("Coordenador de Curso de Ensino Básico ou de Graduação") !== -1){
            admScore.push({subsection: "1", subitem: "10", score: getMonths(radoc[config.sections[9].header][adm]) * 8});
        }
        else if (admTable.indexOf("Vice-diretor de Unidade Acadêmica ou Unidade Acadêmica Especial") !== -1){
            admScore.push({subsection: "1", subitem: "11", score: getMonths(radoc[config.sections[9].header][adm]) * 8});
        }
        else if (admTable.indexOf("Diretor do Hospital Veterinário") !== -1){
            admScore.push({subsection: "1", subitem: "12", score: getMonths(radoc[config.sections[9].header][adm]) * 8});
        }
        else if (admTable.indexOf("Diretor de Órgão da Administração") !== -1){
            admScore.push({subsection: "1", subitem: "13", score: getMonths(radoc[config.sections[9].header][adm]) * 8});
        }
        else if (admTable.indexOf("Coordenador de projeto institucional com financiamento ou de contratos") !== -1){
            admScore.push({subsection: "2", subitem: "1", score: 5});
        }
        else if (admTable.indexOf("Coordenador de curso de especialização, residência médica ou residência") !== -1){
            admScore.push({subsection: "2", subitem: "2", score: 10});
        }
        else if (admTable.indexOf("Membro representante de classe da carreira docente no CONSUNI") !== -1){
            admScore.push({subsection: "2", subitem: "3", score: 10});
        }
        else if (admTable.indexOf("Membro do Conselho de Curadores ou do Plenário do CEPEC ou de Conselho") !== -1){
            admScore.push({subsection: "2", subitem: "4", score: 10});
        }
            ...
            admScore.push({subsection: "2", subitem: "5", score: maxScore});
        }
        else if (admTable.indexOf("Presidente da CPPD") !== -1){
            admScore.push({subsection: "3", subitem: "1", score: getMonths(radoc[config.sections[9].header][adm]) * 7});
        }
        else if (admTable.indexOf("Presidente da Comissão de Avaliação Institucional ou da Comissão Própria") !== -1){
            admScore.push({subsection: "3", subitem: "2", score: getMonths(radoc[config.sections[9].header][adm]) * 5});
        }
        else if (admTable.indexOf("Membros da Coordenação Permanente do Centro de Seleção") !== -1){
            admScore.push({subsection: "3", subitem: "3", score: getMonths(radoc[config.sections[9].header][adm]) * 5});
        }
        else if (admTable.indexOf("Diretores do HC") !== -1){
            admScore.push({subsection: "3", subitem: "4", score: getMonths(radoc[config.sections[9].header][adm]) * 5});
        }
        else if (admTable.indexOf("Presidente do Comitê de Ética em Pesquisa da UFG e do HC/UFG") !== -1){
            admScore.push({subsection: "3", subitem: "5", score: getMonths(radoc[config.sections[9].header][adm]) * 5});
        }
        else if (admTable.indexOf("Membros da CPPD ou da Comissão de Avaliação Institucional") !== -1){
            admScore.push({subsection: "3", subitem: "6", score: getMonths(radoc[config.sections[9].header][adm]) * 5});
        }
        else if (admTable.indexOf("Coordenador de Pesquisa ou de Ensino ou de Extensão") !== -1){
            admScore.push({subsection: "3", subitem: "7", score: getMonths(radoc[config.sections[9].header][adm]) * 3});
        }
        else if (admTable.indexOf("Chefe de Departamento") !== -1){
            admScore.push({subsection: "3", subitem: "8", score: getMonths(radoc[config.sections[9].header][adm]) * 3});
        }
        else if (admTable.indexOf("Chefe do Pronto Socorro ou da Maternidade ou do CEROF") !== -1){
            admScore.push({subsection: "3", subitem: "9", score: getMonths(radoc[config.sections[9].header][adm]) * 3});
        }
        else if (admTable.indexOf("Coordenador das Atividades de Interação com a Sociedade") !== -1){
            admScore.push({subsection: "3", subitem: "10", score: getMonths(radoc[config.sections[9].header][adm]) * 3});
        }
        else if (admTable.indexOf("Coordenador das Atividades de Pesquisa e de Pós–Graduação lato sensu") !== -1){
            admScore.push({subsection: "3", subitem: "11", score: getMonths(radoc[config.sections[9].header][adm]) * 3});
        }
        else if (admTable.indexOf("Membros do Comitê de Ética da UFG e do HC/UFG") !== -1){
            admScore.push({subsection: "3", subitem: "12", score: getMonths(radoc[config.sections[9].header][adm]) * 3});
        }
        else if (admTable.indexOf("Membros do Comitê Interno e Externo do PIBIC") !== -1){
            admScore.push({subsection: "3", subitem: "13", score: getMonths(radoc[config.sections[9].header][adm]) * 3});
        }
            ...
            if (cha < 150)
                maxScore = maxScore * (cha / 150);
            admScore.push({subsection: "4", subitem: "1", score: maxScore});
        }
        else if (admTable.indexOf("Representante titular em conselho de classe profissional") !== -1){
            admScore.push({subsection: "4", subitem: "2", score: 10});
        }
        else if (admTable.indexOf("Diretor do Sindicato de Docentes da UFG") !== -1){
            admScore.push({subsection: "4", subitem: "3", score: 3});
        }
            ...
            if (cha < 150)
                maxScore = maxScore * (cha / 150);
            admScore.push({subsection: "4", subitem: "4", score: maxScore});
        }
            ...
            if (cha < 150)
                maxScore = maxScore * (cha / 150);
            admScore.push({subsection: "4", subitem: "5", score: maxScore});
        }
            ...
            if (cha < 150)
                maxScore = maxScore * (cha / 150);
            admScore.push({subsection: "4", subitem: "6", score: maxScore});
        }
        else{
            admScore.push({subsection: "", subitem: "", score: 0});
        }
    }
    ...
    for (var academic = 0; academic < radoc[config.sections[8].header].length; academic++){
        ...
        if (acdTable.indexOf("Membro de banca de concurso para docente efetivo") !== -1){
            ...
            acdScore.push({subsection: "2", subitem: "9", score: 2});
        }
        else if (acdTable.indexOf("Coordenador de projeto institucional de intercâmbio internacional") !== -1){
            acdScore.push({subsection: "2", subitem: "10", score: 10});
        }
        else{
            acdScore.push({subsection: "", subitem: "", score: 0});
        }
    }
    ...
    for (var qualification = 0; qualification < radoc[config.sections[7].header].length; qualification++){
        ...
        if (quaTable.indexOf("Docente regularmente matriculado em curso de doutorado com relatórios") !== -1){
            ...
            quaScore.push({subsection: "3", subitem: "5", score: 1});
        }
        else if (quaTable.indexOf("Participação em Congressos, Seminários, Encontros, Jornadas") !== -1){
            quaScore.push({subsection: "3", subitem: "6", score: 1});
        }
        else{
            quaScore.push({subsection: "", subitem: "", score: 0});
        }
    }
